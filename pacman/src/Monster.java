...
public class Monster extends Actor implements PortalsListener
{
  private Game game;
  ...
  private void walkApproach()
  {
    ...
    // Teleport monster
    game.getPortal().teleportActor("monster");
  ...
  @Override
  public void teleport(Location warpLocation) {
    setLocation(warpLocation);
  }
}
